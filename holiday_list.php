        ...
        if($status)
        {
             ...
             while ($row = mysqli_fetch_assoc($status))
            {
               ...
               echo '<tr class="odd" role="row">';
                       ...
                       echo "<td class='sorting_1'><center><a href=holiday_viewmore_emp.php?id=".$row['Holiday_id']."><button class='btn btn-info btn-circle-lg waves-effect waves-circle waves-float' name=information type='button'>

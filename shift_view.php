            ...
            <div class="block-header">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <b>SHIFT VIEW<div style="margin-left: 85%">
                                <input class="btn btn-primary waves-effect" name="add" type="submit"   formaction="./shift.php" value="ADD SHIFT"></button></b></div>
                            </h2>
             ...
             while ($row = mysqli_fetch_assoc($status))
            {
                    ...
                    echo '<tr class="odd" role="row">';
                       ...
                       /* echo "<td>".$row['Created_date']."</td>";
                        ...
                        echo "<td class='sorting_1'><center><a href=shift_viewmore.php?id=".$row['Shift_id']."><button class='btn btn-info btn-circle-lg waves-effect waves-circle waves-float' name=information type='button'>
                            <i class='material-icons'>information</i>
                       </button></a></td>";

                        echo "<td class='sorting_1'><center><a href=Shift1.php?id=".$row['Shift_id']."><button class='btn btn-success btn-circle-lg waves-effect waves-circle waves-float' name='update' type='button'>
                                    <i class='material-icons'>update</i>
                                </button></a></td>";


                      echo "<td class='sorting_1'><center><a href=shift_delete.php?id=".$row['Shift_id']."><button class='btn btn-danger btn-circle-lg waves-effect waves-circle' waves-float name=delete type='button' >

        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email"><?php print "$e"; ?></div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="<?=ADMIN_URL?>applyforleave.php"><img src='apply.jpg' style='width:35px;height:35px;'><span>APPLY FOR LEAVES</span></a>
                   
                    </li>
                    <li>
                    <a href="<?=ADMIN_URL?>emp_chat.php"><img src='msg.jpg' style='width:35px;height:35px;'>
                        <span>CHAT</span></a>
